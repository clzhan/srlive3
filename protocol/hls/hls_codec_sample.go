...
func newCodecSample() *codecSample {
	return &codecSample{
		isVideo:       false,
		frameType:     RtmpCodecVideoAVCFrameReserved,
		avcPacketType: RtmpCodecVideoAVCTypeReserved,
		soundRate:     RtmpCodecAudioSampleRateReserved,
		soundSize:     RtmpCodecAudioSampleSizeReserved,
		soundType:     RtmpCodecAudioSoundTypeReserved,
		aacPacketType: RtmpCodecAudioTypeReserved,
	}
}
...
func (sample *codecSample) clear() (err error) {
	...
	sample.cts = 0
	sample.frameType = RtmpCodecVideoAVCFrameReserved
	sample.avcPacketType = RtmpCodecVideoAVCTypeReserved

	sample.soundRate = RtmpCodecAudioSampleRateReserved
	sample.soundSize = RtmpCodecAudioSampleSizeReserved
	sample.soundType = RtmpCodecAudioSoundTypeReserved
	sample.aacPacketType = RtmpCodecAudioTypeReserved
