...
func (r *RtmpChunker) writeMetadata(data *avformat.MediaFrame) error {
	chunk := &RtmpChunk{
		RTMP_CHANNEL_DATA,
		0,
		0,
		uint32(data.Payload.Len()),
		rtmpconst.RTMP_MSG_AMF_META,
		r.streamid,
		false,
		bytes.NewBuffer(nil),
	}
	...
	buf.WriteByte(rtmpconst.RTMP_MSG_AMF_META)
...
func (r *RtmpChunker) writeFullVideo(video *avformat.MediaFrame) (err error) {
...
func (r *RtmpChunker) writeFullAudio(audio *avformat.MediaFrame) (err error) {
...
func (r *RtmpChunker) writeVideo(video *avformat.MediaFrame) (err error) {
...
func (r *RtmpChunker) writeAudio(audio *avformat.MediaFrame) (err error) {
